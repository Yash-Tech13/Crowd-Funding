    ...
    <>
      <div className="justify-center item-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          {/* content */}
          <div className="border-0 rounder-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            {/* header */}
            ...
            <div className="relative p-6 flex-auto">
              ...
              <input
                ...
                required
                type="text"
                className="flex-grow w-full h-12 p-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                id="firstName"
                name="firstName"
              />
            ...
            {/* footer */}
            <div className="flex item-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
              <button
              ...
              <button
                className="background text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hower:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                type="button"
